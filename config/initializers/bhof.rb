Rails3MongoidDevise::Application.configure do
  ...
  ::BHOF_DISCOUNT_DEADLINE =  DateTime.new(2015,1,5,0,0,00,'+8')  #'11:59pm PDT on January 19, 2015'
  ::BHOF_FINAL_DEADLINE =  DateTime.new(2015,1,19,23,59,00,'+8')  #'11:59pm PDT on January 19, 2015'
